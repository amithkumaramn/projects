...
function init() {
	...
	$('#aqua').get(0).addEventListener('click', function(e) { onColorClick(e.target.id); }, false);
	...
	$('#apple').get(0).addEventListener('click', function(e) { onStamp(e.target.id); }, false);
	$('#rose').get(0).addEventListener('click', function(e) { onStamp(e.target.id); }, false);
	$('#parrot').get(0).addEventListener('click', function(e) { onStamp(e.target.id); }, false);
	$('#heart').get(0).addEventListener('click', function(e) { onStamp(e.target.id); }, false);
	$('#bmw').get(0).addEventListener('click', function(e) { onStamp(e.target.id); }, false);
